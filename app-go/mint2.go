...
func owner(contract *client.Contract) {
	...
	ownerer, err := contract.EvaluateTransaction("OwnerOf", "040d5fdfd6154b5cc4f2baed3e03e3c1e24946a75d8b589f105464295f086c88-0")
	if err != nil {
...
func transfer(contract *client.Contract) {
	...
	_, err := contract.SubmitTransaction("TransferFrom", "x509::CN=user1,OU=client,O=Hyperledger,ST=North Carolina,C=US::CN=ca.org2.example.com,O=org2.example.com,L=Hursley,ST=Hampshire,C=UK", "x509::CN=user1,OU=client,O=Hyperledger,ST=North Carolina,C=US::CN=ca.org1.example.com,O=org1.example.com,L=Durham,ST=North Carolina,C=US", "5c39f7abeaae42ae57531a5d6e21f57a8c76ae7a60c2a611171c0617154591b2-1")
	if err != nil {
